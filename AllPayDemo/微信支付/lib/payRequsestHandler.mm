...
//    NSString *order_price   = @"1";//1分钱测试
    ...
    if ( prePayid != nil) {
        ...
        NSDate *today = [NSDate date];//格林尼治时间（GMT）
        ...
        //        NSDate *now = [today dateByAddingTimeInterval:interval];
...
- ( NSMutableDictionary *)sendPay_demoWithopenID:(NSString *)openID
    ...
    NSString *time_stamp  = [NSString stringWithFormat:@"%lld", timeStamp.longLongValue/1000];
